<?php
/**
 * Monthly Payment Tracker - Fixed Version 2
...
class MonthlyPaymentTracker {
    ...
    public function allocatePayment($bookingId, $paymentAmount, $paymentDate, $paymentMethod, $transactionId = null, $mpesaReceipt = null) {
        ...
        if ($stmt->execute()) {
            ...
            error_log("UPDATE affected $affectedRows rows for booking $bookingId, month $nextUnpaidMonth");
...
// Test the system
if (isset($_GET['test'])) {
    echo "<h2>Monthly Payment Tracker Test - Fixed Version 2</h2>";
