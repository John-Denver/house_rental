...
// Include header
$pageTitle = 'Complete Payment - M-Pesa';
                            ...
                            <div class="payment-methods">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <div class="mpesa-logo">
                                                    ...
                                                    <p class="text-muted small">M-Pesa</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card border-secondary">
                                    <div class="card-header bg-secondary text-white">
                                        <h6 class="mb-0">
                                            <i class="fas fa-credit-card me-2"></i>Other Payment Methods
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <p class="text-muted mb-3">Alternative payment options coming soon.</p>
                                        <div class="row">
                                            <div class="col-6">
