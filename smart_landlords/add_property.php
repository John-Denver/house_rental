...
<body>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="propertyForm">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="property_status">Active Status</label>
                            </div>
    ...
    <script>
        document.getElementById('property_main_image').addEventListener('change', function () {
            ...
            if (files.length > 0) {
                this.nextElementSibling.textContent = `Selected file: ${files[0].name}`;
            }
        });
        ...
        document.getElementById('property_additional_media').addEventListener('change', function () {
            const files = this.files;
            if (files.length > 0) {
                this.nextElementSibling.textContent = `Selected ${files.length} files`;
            }
        });
    </script>
</body>
